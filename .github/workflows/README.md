...
| --- | --- | --- |
| [`ci.yml`](ci.yml) | push to `main`, every PR, manual | Typecheck, tests, build and SSR smoke on the Node version pinned in `.nvmrc`; repository hygiene, documentation links, shell scripts, commit messages, workflow syntax |
